...
// Asegúrate de importar el modelo Cliente al inicio del archivo
const Cliente = require("../models/Cliente") // Ajusta la ruta según tu estructura de archivos

// El resto de tu código del controlador...

// En la función register (línea ~131), asegúrate de que estás usando el modelo correctamente
const register = async (req, res) => {
  try {
    const { role, nuevoUsuario } = req.body // Declare the variables here

    // ... código existente ...

    // Si estás creando un cliente, asegúrate de usar el modelo importado
